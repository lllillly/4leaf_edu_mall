  ...
  produce(state, (draft) => {
    switch (action.type) {
      ...
      case PRODUCT_TYPE_CREATE_REQUEST:
        draft.st_typeCreateLodaing = true;
        draft.st_typeCreateDone = false;
        draft.st_typeCreateError = null;
        break;

      case PRODUCT_TYPE_CREATE_SUCCESS:
        draft.st_typeCreateLodaing = false;
        draft.st_typeCreateDone = true;
        draft.st_typeCreateError = null;
        draft.createModal = !draft.createModal; // modal 켜져있던 상태이므로 꺼짐
        break;
